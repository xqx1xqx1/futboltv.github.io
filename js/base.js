...
menuLoad.each(function(){
    ...
    setTimeout(function(){
    	var iframe = document.getElementById("opcion1").href;
	$('#iframe').get(0).contentWindow.location.replace(opcion1);
    },0);
});
//-----------------------------------------------------------------------
// Template Settings
...
var switchDarkMode = document.querySelectorAll(".damo-switch");
var pageBodyActive = pageBody.classList.contains("damo");

// Check if enable as default
if (Finapp.Dark_Mode.default) {
    pageBody.classList.add("damo");
}
...
// if dark mode on
if (checkDarkModeStatus === 1 || checkDarkModeStatus === "1" || pageBody.classList.contains('damo')) {
...
switchDarkMode.forEach(function (el) {
    el.addEventListener("click", function () {
        ...
        var bodyCheck = pageBody.classList.contains('damo');
        if (darkmodeCheck === 1 || darkmodeCheck === "1" || bodyCheck) {
            pageBody.classList.remove("damo");
...
function testMode() {
    ...
    // Theme
    if (pageBody.classList.contains("damo")) {
...
//-----------------------------------------------------------------------
 ...
 $("#reporte2").removeAttr("data-bs-target");

 $('#reporte2'). attr('data-bs-target', '#chat');

$('#reporte2').html('<ion-icon name="chatbox-ellipses-outline"></ion-icon>Usa el chat para reportar');
  
//   $('#reporte2').html('<ion-icon name="alert-circle-outline"></ion-icon> Reportar: Canal caÃ­do');
...
// Pero ella cambia mÃ¡s de novio que de panty
